...
public class FileService {
    ...
    public FileUploadResponse upload(MultipartFile multipartFile) {
        ...
        Path directoryPath = Paths.get(this.servletContext.getRealPath("/")).resolve(DIRECTORY_PATH);
    ...
    public Resource loadFileAsResource(String fileId) {
        Path filePath = Paths.get(this.servletContext.getRealPath("/")).resolve(DIRECTORY_PATH).resolve(fileId);
        try {
